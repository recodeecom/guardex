# hook-guardrails Specification

## Purpose
TBD - created by archiving change agent-codex-block-shell-output-redirect-hook-bypass-2026-04-28-11-01. Update Purpose after archive.
## Requirements
