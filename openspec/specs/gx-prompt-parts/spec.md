# gx-prompt-parts Specification

## Purpose
TBD - created by archiving change agent-codex-improve-gx-prompt-parts-for-token-usage-2026-04-22-16-05. Update Purpose after archive.
## Requirements
