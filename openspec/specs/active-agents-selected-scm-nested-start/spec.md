# active-agents-selected-scm-nested-start Specification

## Purpose
TBD - created by archiving change agent-codex-active-agents-selected-scm-nested-start-2026-05-11-15-59. Update Purpose after archive.
## Requirements
