# fix-codex-hook-path-and-worktree-flow Specification

## Purpose
TBD - created by archiving change agent-codex-fix-codex-hook-path-and-worktree-flow-2026-04-20-08-43. Update Purpose after archive.
## Requirements
