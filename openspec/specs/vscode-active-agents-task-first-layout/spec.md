# vscode-active-agents-task-first-layout Specification

## Purpose
TBD - created by archiving change agent-codex-active-agents-task-first-layout-2026-04-23-12-29. Update Purpose after archive.
## Requirements
